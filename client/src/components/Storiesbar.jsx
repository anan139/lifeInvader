    ...
    <div className='w-screen sm:w-[calc(100vw-240px)] lg:max-w-2xl overflow-x-auto no-scrollbar px-4'>
      <div className='flex flex-row gap-4 pb-5 whitespace-nowrap'>
        ...
        {stories.map((story, index) => (
          <div onClick={() => setViewStory(story)} key={index} className='relative rounded-lg shadow min-w-30 max-w-30 max-h-40 cursor-pointer hover:shadow-lg transition-all duration-200 bg-gradient-to-b from-red-400 to-rose-600 hover:from-red-600 hover:to-rose-700 active:scale-95 inline-block'>
