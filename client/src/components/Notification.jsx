...
const Notification = ({t, message}) => {
  ...
  return (
    <div className='max-w-md w-full p-4 bg-white shadow-lg rounded-lg flex border border-gray-300 hover:scale-105 transition'>
        ...
        <div className='flex border-l border-gray-200'>
            <button onClick={()=>{
                ...
                toast.dismiss(t.id);
            }} className='p-4 text-rose-600 font-semibold'>
                Reply
            </button>
        </div>
    </div>
