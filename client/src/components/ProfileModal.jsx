...
const ProfileModal = ({setShowEdit}) =>{
    ...
    const [editFrom, setEditFrom] = userState({
                ...
                <form className='space-y-4' onSubmit={handleSaveProfile}>
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        ...
                        text-gray-700 mb-1'>
                            ...
                            className="w-full p3 border border-gray-200 rounded-lg" 
                            onChange={(e)=>setEditFrom({...editFrom, profile_picture: e.target.files[0]})} />
                            <div className='group/profile relative'>
                                 <img src={editFrom.profile_picture ? URL.createObjectURL
                                    (editFrom.profile_picture) : user.profile_picture}
                      ...
                      text-gray-700 mb-1">
                        ...
                        <input hidden type="file" accept="image/*" id="cover_photo"
                            ...
                            <div className='group/cover relative'>
                                <img src={editFrom.cover_photo ? URL.createObjectURL(editFrom.cover_photo)
                  ...
                  <div>
                    ...
                    rounded-lg' placeholder='Please enter your full name' onChange={(e)=>
                        setEditFrom({...editFrom, full_name: e.target.value})} value={editFrom.full_name}/>
                  </div>
                  ...
                  <div>
                    ...
                    <input type="text" className='w-full p-3 border border-gray-200 
                    rounded-lg' placeholder='Please enter your username' onChange={(e)=>
                        setEditFrom({...editFrom, username: e.target.value})} value={editFrom.username}/>
                  </div>
                  ...
                  <div>
                    ...
                    rounded-lg' placeholder='Please enter a short bio' onChange={(e)=>
                        setEditFrom({...editFrom, bio: e.target.value})} value={editFrom.bio}/>
                  </div>
                  ...
                  <div>
                    ...
                    rounded-lg' placeholder='Please enter your location' onChange={(e)=>
                        setEditFrom({...editFrom, location: e.target.value})} value={editFrom.location}/>
                  </div>
